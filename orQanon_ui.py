...
#
# Created: Thu Nov 20 22:04:00 2014
...
"*/")
        ...
        self.doubleSpinBox_1.setProperty("value", 0.7)
        ...
        self.gridLayout_6.addWidget(self.pushButton_reset, 1, 0, 1, 1)
        self.pushButton_synth = QtWidgets.QPushButton(self.groupBox_7)
        self.pushButton_synth.setObjectName("pushButton_synth")
        self.gridLayout_6.addWidget(self.pushButton_synth, 0, 0, 1, 1)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.pushButton_reset.setText(_translate("mainWindow", "Reset GUI"))
